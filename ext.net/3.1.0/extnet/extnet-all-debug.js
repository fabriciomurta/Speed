...
Ext.override(Ext.grid.feature.AbstractSummary, {
    getSummary: function (store, type, field, group) {
        ...
        if (type) {
            ...
            switch (type) {
                case 'count':
                    return item.totalCount; // this addresses #692 gitHub issue
                case 'min':
...
Ext.define("Ext.grid.column.ComponentColumn", {
    ...
    onCmpSpecialKey: function (cmp, e) {
        var store = cmp.column.gridRef.store,
            grid = cmp.column.gridRef,
...
(function () {
    ...
    buf.push("div.x-mask { border: none; }"); // #622
