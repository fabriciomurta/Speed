...
if(tag.closable){closeEl=Ext.get(el.query(".x-taglabel-close-btn")[0]);closeEl.hover(function(){!this.tag.disabled&&this.el.addCls("x-taglabel-close-btn-over");},function(){!this.tag.disabled&&this.el.removeCls("x-taglabel-close-btn-over");},{tag:tag,el:closeEl});closeEl.on({mousedown:function(){var field=this.label.field;if(field.isExpanded){field.collapse=Ext.emptyFn;}},click:function(){!this.tag.disabled&&this.label.remove(this.tag);this.label.field.collapse=this.label.field.originalCollapse;},scope:{label:this,tag:tag}});}
