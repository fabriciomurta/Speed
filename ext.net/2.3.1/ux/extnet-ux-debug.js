        ...
        if (me.droppable || me.dropGroup){
            me.dropZone = Ext.create('Ext.view.DropZone', {
                ...
                handleNodeDrop: function(data, dropRecord, position) {
                    if (me.fireEvent('drop', me, data, dropRecord, position) === false) {
                        return false;
                    }
...
Ext.define("Ext.net.ClearButton", { 
    ...
    getPosition: function() { 
        ...
        if (this.field.triggerWrap) { 
            right += this.field.getTriggerWidth(); 
        } 
    ...
    updatePosition: function() { 
        if (this.el) { 
            ...
            this.el.setRight(pos.right).setTop(pos.top);
        }                 
    }, 
...
Ext.define("Ext.net.FilterHeader", {
            ...
            date : [
                {
                    ...
                    serialize : function (value) {
                        return {
                            type : "date",
                            op: "=",
                            value : Ext.Date.format(value, Ext.net.FilterHeader.behaviour.getOption("submitDateFormat") || "c")
                        };
                    }
                },

                {
                    ...
                    serialize : function (value) {
                        var serValue = {},
                            format = Ext.net.FilterHeader.behaviour.getOption("submitDateFormat") || "c";
    ...
    getValue : function (includeEmpty) {
        ...
        Ext.each(this.fields, function(field) {     
            var value = field.getValue();
            if(!Ext.isEmpty(value) || includeEmpty === true) {
                value[field.column.dataIndex] = value;
            }
        });
        ...
        Ext.each(this.fields, function(field){
            ...
            if (!Ext.isEmpty(field.getValue(), false)) {
                if (field.isSmart) {
                    ...
                    val = field.getFilterValue ? field.getFilterValue() : field.getValue();
    ...
    isSmartFilterValid : function (field) {
        if (field.isSmart) {
            this.selectSmartFilter(this.getFieldType(field), null, field.getValue(), field);
...
Ext.define("Ext.net.MultiUpload", {
	...
	swfUploadUploadStarted : function(file) {
        ...
        if (this.buildPostParams) {            
            this.multiUpload.setPostParams(this.buildPostParams(file));
        }
	...
	swfUploadUploadError : function (file, errorCode, message) {
		...
		return this.fireEvent("uploaderror", this, this.swfUploadQueue[file.id], errorCode, message);
	},
