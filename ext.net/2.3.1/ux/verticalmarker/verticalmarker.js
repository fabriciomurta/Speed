...
return{item:foundItem,dist:foundDist,i:items.length-1,length:items.length};},onMouseLeave:function(e){this.hideVisibleStuff();},hideVisibleStuff:function(){var me=this;if(me.markerSprite){me.markerSprite.hide(true);}
