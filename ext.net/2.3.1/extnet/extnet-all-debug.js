...
Ext.define("Ext.net.LinkButton", {
    ...
    onRender : function (ct, position) {
        ...
        if (this.pressed && this.allowDepress !== false) {
            this.setDisabled(true);
            this.disabled = false;
            this.textEl.dom.style.cursor = "pointer";
        }
    },
...
Ext.grid.plugin.Editing.override({
    onReconfigure: function() {
        var grid = this.grid,
            columnManager = grid.getView().ownerCt.columnManager,
            columns;
...
Ext.define('Ext.ux.RowExpander', {
    ...
    collapseAll : function () {
        ...
        this.recordsExpanded = {};
        this.getCmp().view.rowBodyFeature.recordsExpanded = this.recordsExpanded;
    },
