...
this.callParent();},onItemClick:Ext.emptyFn,onListSelectionChange:Ext.emptyFn,getValue:function(){var state=[],value,record;Ext.each(this.value,function(obj){state.push(obj.value);},this);return this.valueMode=="array"?state:state.join(this.getDelimeter());},getDelimeter:function(){if(this.tagLabel){return this.tagLabel.tagsDelimeter;}
