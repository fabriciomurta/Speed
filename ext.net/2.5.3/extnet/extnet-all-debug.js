...
(function () {
    ...
    buf.push(".x-menu-item-active .x-menu-item-icon { left: 2px; top: 3px; }"); // The GitHub issue #538
    buf.push(".x-theme-neptune .x-menu-item-active .x-menu-item-icon { left: 3px; top: 5px; }"); // The GitHub issue #538
