...
me.mun(me.inputEl,Ext.supports.SpecialKeyDownRepeat?'keydown':'keypress',me.fireKey,me);for(e=0;e<eLen;e++){event=events[e];me.mun(me.inputEl,event,me.onChangeEvent);}
me.usesPropertychange=false;},setEditable:function(editable){me.inputEl.setDisplayed(editable);this.callParent();},onRender:function(){var me=this;me.callParent(arguments);if(!me.tagLabel){me.initTagLabel();}},initTagLabel:function(){var me=this;(this.inputCell||this.bodyEl).addCls(["x-form-field","x-form-text","x-field-buttons-body"]);this.bodyEl.addCls("x-field-toolbar-body");this.inputEl.addCls=Ext.Function.createSequence(this.inputEl.addCls,function(cls){(this.inputCell||this.bodyEl).addCls(cls);},this);this.inputEl.removeCls=Ext.Function.createSequence(this.inputEl.removeCls,function(cls){(this.inputCell||this.bodyEl).removeCls(cls);},this);me.tagLabel=new Ext.net.TagLabel(Ext.apply({emptyText:me.emptyText||'',field:me,inputEl:me.inputEl,defaultClosable:me.defaultClosable,afterChange:Ext.Function.bind(me.afterTagsChange,me),tagsDelimeter:me.delimiter,renderTo:me.inputEl.parent().dom},{tags:this.value||[]},me.tagLabelCfg||{}));if(me.tagLabel.stacked){this.addCls("x-tagcombo-stacked");}
...
if(key==e.ENTER&&rawValue.length!=0){e.stopEvent();}else if(key==e.LEFT){if(pos==0&&me.inputMoving){me.tagLabel.moveInput(-1,pos);me.selectText(0,0);}}else if(key==e.RIGHT){if(pos==rawValue.length&&me.inputMoving){me.tagLabel.moveInput(1,pos);me.selectText(pos,pos);}}
...
this.callParent(arguments);if(removeCls){picker.removeCls("x-hide-visibility");}},getNavigationModel:function(){var me=this,result;result=me._origGetNavigationModel.apply(this,arguments);if(me.pickerField.hideSelected&&result&&!result._originalSetPosition){result._originalSetPosition=result.setPosition;result.setPosition=this.pickerField.setPosition;}
return result;},setPosition:function(recordIndex,keyEvent,suppressEvent,fromSelectionModel){var me=this,view=this.view,dataSource=view.dataSource,selModel=view.getSelectionModel(),len=dataSource.getCount(),direction,newRecord,newRecordIndex;if(recordIndex!=null){if(typeof recordIndex==='number'){newRecordIndex=Math.max(Math.min(recordIndex,dataSource.getCount()-1),0);newRecord=dataSource.getAt(recordIndex);}
...
me._originalSetPosition.call(me,newRecordIndex,keyEvent,suppressEvent,fromSelectionModel);},onBlur:function(){var me=this;if(me.tagLabel&&me.tagLabel.isInputMoving){return;}
