...
Ext.define('Ext.ux.SelectBox', {
    ...
    afterRender: function () {
        ...
        this.mon(this.picker, "itemmouseenter", function (view, record, node, index) {
...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    showTip : function () {
        ...
        if(!record || Ext.isEmpty(record.get('qTip'))){
            this.tip.addCls("x-hidden-visibility");
            return;
        }

        this.tip.removeCls("x-hidden-visibility");
...
Ext.define('Ext.ux.Spotlight', {
    ...
    applyBounds: function(animate, reverse) {
        var me = this,
            ...
            viewHeight = Ext.Element.getViewportHeight(true),
            i = 0,
            config = false,
            from, to, clone;
...
Ext.define('Ext.net.TagField', {
    ...
    getNavigationModel: function () {
        ...
        if (me.pickerField.hideSelected && result && !result._originalSetPosition) {
            ...
            result.setPosition = this.pickerField.setPosition;
        }
    ...
    onBlur: function () {
        ...
        if (me.tagLabel && me.tagLabel.isInputMoving) {
            return;
        }
