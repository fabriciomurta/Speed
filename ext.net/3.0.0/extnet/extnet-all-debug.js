...
Ext.define("Ext.net.HyperlinkButton", {
    ...
    valueElement : function () {
        ...
        textEl.setAttribute("href", "javascript:;");
    ...
    onEnable : function () {
        ...
        this.textEl.setAttribute("href", "javascript:;");
    }
});
...
Ext.override(Ext.form.field.Text, {
    ...
    destroy: function () {
        ...
        if (this.leftButtonsCt) {
            Ext.remove(this.leftButtonsCt);
            this.leftButtonsCt = null;
        }

        if (this.rightButtonsCt) {
            Ext.remove(this.rightButtonsCt);
...
Ext.data.ProxyStore.override({
    ...
    onBatchException: function (batch, operation) {
        ...
        this.onProxyException(this.proxy, null, operation);
    },
...
Ext.grid.Panel.override({
    ...
    reserveScrollbar: true, // temp fix for grid's columns misaligning
...
Ext.define("Ext.grid.column.ComponentColumn", {
    ...
    mayShowPin: function () {
        if (this.pin && this.pinnedOnRecord && this.grid.store.indexOf(this.pinnedOnRecord) > -1) {
...
Ext.grid.filters.filter.List.override({
    setValue: function(value) { // The GitHub issue #542
        if (arguments.length === 1) {
            ...
            if (this.active) {
                this.updateStoreFilter(this.filter);
            } else {
